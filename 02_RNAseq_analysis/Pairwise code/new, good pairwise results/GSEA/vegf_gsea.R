...
pr <- read.csv("vegf_quartile_results.csv", stringsAsFactors = FALSE) 
...
write.csv(
  ...
  file      = "vegf_GSEA_Hallmark_preRanked.csv",
  row.names = FALSE
)
...
write.csv(
  ...
  file      = "vegf_GSEA_C2_preRanked.csv",
  row.names = FALSE
)
...
write.csv(
  ...
  file      = "vegf_GSEA_C6_preRanked.csv",
  row.names = FALSE
)
