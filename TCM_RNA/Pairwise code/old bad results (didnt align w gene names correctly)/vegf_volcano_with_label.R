# =========================================
# VEGF High vs. Low: Shrunken Volcano + Highlight
# =========================================
...
vegf_groups <- read.csv("vegf_groups.csv",     stringsAsFactors = FALSE)

# 2) Subset your VEGF samples (adjust cols as needed) ----
raw_vegf <- raw %>%
  dplyr::select(1, 3, 4, 6:8, 14:18, 22, 25)
...
ens.id   <- "ENSCAFG00000003904"  # ← fill in your ENSCAF ID
symbol   <- "CXCL8"               # ← fill in the label you want
...
# plot + save
print(p_volcano)
ggsave("volcano_VEGF_highlight.png",
       p_volcano,
       width  = 7,
       height = 5,
       dpi    = 600,
