...
pr <- read.csv("il.8_quartile_results.csv", stringsAsFactors = FALSE) 
...
write.csv(
  ...
  file      = "il.8_GSEA_Hallmark_preRanked.csv",
  row.names = FALSE
)
...
write.csv(
  ...
  file      = "il.8_GSEA_C2_preRanked.csv",
  row.names = FALSE
)
...
write.csv(
  ...
  file      = "il.8_GSEA_C6_preRanked.csv",
  row.names = FALSE
)
