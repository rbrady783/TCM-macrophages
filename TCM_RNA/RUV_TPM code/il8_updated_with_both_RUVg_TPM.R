...
# Date:   2024-02-28
#
# Project Name: il_8_RUV_v2 with new dogs 2 and 3 - IMPROVED
#########################################################
#########################################################  
...
# Saving the data
fn <- paste0("C:/Users/brady/OneDrive/Desktop/TCM_RNA/Output/CorrelationTables/il_8_RUVg_improved.csv")
...
# Date:   2024-04-07
#
# Project Name: il_8_TPM - IMPROVED
#########################################################
#########################################################  
# Section: Reading in the input data
#########################################################
...
# Saving the data
fn <- paste0("C:/Users/brady/OneDrive/Desktop/TCM_RNA/Output/CorrelationTables/il_8_TPM_improved.csv")
write.csv(fcor.sig, fn, row.names = FALSE)
