...
# Date:   2024-02-28
#
# Project Name: RUVg/TPM

#########################################################  
# Section: Reading in the input data
#########################################################

# Getting the datasheet ##REPLACE CYTOKINE NAME AS NEEDED
gd <- read.csv("ccl2_modz.csv")
...
#########################################################
# Section: FDR Correction - BOTH METHODS RUVg and TPM
#########################################################
...
# Saving the data
fn <- paste0("C:/Users/brady/OneDrive/Desktop/TCM_RNA/Output/CorrelationTables/ccl2_RUVg_improved.csv")
...
# Date:   2024-04-07
#
# Project Name: ccl2_TPM - IMPROVED
#########################################################
...
#########################################################
# Section: FDR Correction - BOTH METHODS FDR and BH
#########################################################
...
# Saving the data
fn <- paste0("C:/Users/brady/OneDrive/Desktop/TCM_RNA/Output/CorrelationTables/ccl2_TPM_improved.csv")
write.csv(fcor.sig, fn, row.names = FALSE)
