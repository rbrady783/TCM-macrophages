...
# Date:   2024-02-28
#
# Project Name: tgfb_RUV_v2 with new dogs 2 and 3 - IMPROVED
#########################################################
#########################################################  
...
# Saving the data
fn <- paste0("C:/Users/brady/OneDrive/Desktop/TCM_RNA/Output/CorrelationTables/tgfb_RUVg_improved.csv")
...
# Date:   2024-04-07
#
# Project Name: tgfb_TPM - IMPROVED
#########################################################
#########################################################  
# Section: Reading in the input data
#########################################################
...
# Saving the data
fn <- paste0("C:/Users/brady/OneDrive/Desktop/TCM/TCM_RNA/RUV_TPM code/tgfb_TPM_improved.csv")
write.csv(fcor.sig, fn, row.names = FALSE)
