...
# # Date:   2024-02-28
#
# Project Name: KClike  cor
#
# Script Description: Correlation protein KClike conc with canine transcriptome
...
# Saving the data
fn <- paste0("C:/Users/brady/OneDrive/Desktop/TCM_RNA/Output/CorrelationTables/KC_like_RUVg.csv")
